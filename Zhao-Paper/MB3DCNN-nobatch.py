...
LOSS_THRESHOLD = 0.00000000000000000000000000001
...
if (USE_KFOLD):
	...
	MRF_model.fit(X, Y, batch_size=len(X), epochs=EPOCHS, verbose=VERBOSE, validation_data=(X_val, Y_val))
